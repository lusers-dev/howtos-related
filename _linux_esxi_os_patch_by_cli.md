...
(NOTE: Since VMware acquisition by Broadcom, this no longer applies)
...
## Download latest patch available from VMware
## https://customerconnect.vmware.com
## (Don’t have an account? Sign for a free account)
## and navigate to Products and Accounts / Product Patches
## and download the latest patch for your ESXi Image profile

## Once the patch zip file is downloaded, upload it to a ESXi server datastore
## Eg: datastore1
